...
- [@7ayush](https://www.github.com/7ayush)
...
- Combine this model with a regression model to predict how much of a credit limit an applicant will be approved for.
...
```bash
git clone https://github.com/7ayush/credit-risk-analysis.git
```
